...
function _init_fields_jacc(settings::Settings, mcd::MPICartDomain,
	...
	ncenter_cells = maxL - min + 1

	JACC.parallel_for((ncenter_cells, ncenter_cells), _populate_jacc!, u, v, offsets, sizes, minL, maxL)
...
function _calculate!(fields::Fields{T, N, <:JACC.Array{T, N}},
	...
	function _calculate_kernel!(j, k, u, v, u_temp, v_temp, sizes, Du, Dv, F, K,
		noise, dt)
